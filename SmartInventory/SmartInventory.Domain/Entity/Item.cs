...
namespace SmartInventory.Domain.Entity
{
    public class Item
    {
        ...
        public string Type { get; set; }            // Metal, Wood, Plastic, Glass, Concrete, Aluminium, Paper, Oil, Tape, Powder
        ...
        public int ActiveStatus { get; set; }        // Active -> 1, Deactive -> 0, Deleted -> -1
    }
}
